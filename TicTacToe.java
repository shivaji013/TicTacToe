...
public class TicTacToe {
	...
	private static boolean isGameFinished(char[][] board) {
		...
		if(hashContestantWon(board, 'X')) {
			printBoard(board);
			System.out.println("Players wins!");
			return true;
		}
		
		if(hashContestantWon(board, 'O')) {
			printBoard(board);
	...
	private static boolean hashContestantWon(char[][] board, char symbol) {
	...
	private static void playerTurn(char[][] board, Scanner scan) {
		...
		while(true) {
			System.out.println("Where whould you like playe? (0-9)");
